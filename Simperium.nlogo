...
to record-bizzlespace-metrics
  ...
  append-bizzlespace-data  6 (count          [my-living-units with [unit-type = "flagship"   ]] of attacker)
  append-bizzlespace-data  7 (count          [my-living-units with [unit-type = "warsun"     ]] of attacker)
  append-bizzlespace-data  8 (count          [my-living-units with [unit-type = "dreadnought"]] of attacker)
  append-bizzlespace-data  9 (count          [my-living-units with [unit-type = "cruiser"    ]] of attacker)
  append-bizzlespace-data 10 (count          [my-living-units with [unit-type = "destroyer"  ]] of attacker)
  append-bizzlespace-data 11 (count          [my-living-units with [unit-type = "carrier"    ]] of attacker)
  append-bizzlespace-data 12 (count          [my-living-units with [unit-type = "fighter"    ]] of attacker)
  append-bizzlespace-data 13 (count          [my-living-units with [unit-type = "infantry"   ]] of attacker)
  ...
  append-bizzlespace-data 19 (count          [my-living-units with [unit-type = "flagship"   ]] of defender)
  append-bizzlespace-data 20 (count          [my-living-units with [unit-type = "warsun"     ]] of defender)
  append-bizzlespace-data 21 (count          [my-living-units with [unit-type = "dreadnought"]] of defender)
  append-bizzlespace-data 22 (count          [my-living-units with [unit-type = "cruiser"    ]] of defender)
  append-bizzlespace-data 23 (count          [my-living-units with [unit-type = "destroyer"  ]] of defender)
  append-bizzlespace-data 24 (count          [my-living-units with [unit-type = "carrier"    ]] of defender)
  append-bizzlespace-data 25 (count          [my-living-units with [unit-type = "fighter"    ]] of defender)
  append-bizzlespace-data 26 (count          [my-living-units with [unit-type = "infantry"   ]] of defender)
  append-bizzlespace-data 27 (count          [my-living-units with [unit-type = "pds"        ]] of defender)
